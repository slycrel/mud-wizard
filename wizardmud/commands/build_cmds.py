...
class CmdWorldInit(Command):
    ...
    def _intro(wb):
        ...
        return (
            ...
            "the tale. Simply say what you do, in your own words, and the world will answer.\"\n\n"
            "|wHow to play:|n  just describe your actions naturally — for example:\n"
            "  |wsearch the collapsed library for a hidden way|n\n"
            "  |wdecipher the storm-runes on the wall|n\n"
            "  |wgo south|n  ·  |wlook around|n  ·  |wask the Wizard what I should do|n\n"
            "The world judges your ideas: a clever approach succeeds, and you can never\n"
            "reach a dead end. (|winspect <thing>|n draws a picture on the web client.)\n"
        )
